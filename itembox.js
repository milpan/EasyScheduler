...
var itemboxinjection = `<div class="dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);"><h1>Draggable Tasks</h1><div class="origin">${stringtoinject}</div><div id="draggable-${count_Tasks+1}" class="item" draggable="true" ondragstart="onDragStart(event);"><i contenteditable="true" onblur="onBlur(event);" id="dragtext-${count_Tasks+1}">+ Try Custom Text Here</i></div></div>`;
